...
var tikaParserStage = function (doc) {
    ...
    if (doc != null && doc.getId() != null) {
        ...
        var fileSize = getFileSizeFromPipelineDoc(doc);//getFileSize(doc.getId());
            ...
            /*    var oracle = new URL(doc.getId());
                ...
                */
                if(doc !== null && doc.getFirstFieldValue("_raw_content_") !== null){
                    var raw = doc.getFirstFieldValue("_raw_content_").toString();
...
function getFileSizeFromPipelineDoc(doc){
    var size = 0;
    var e = java.lang.Exception;
    try{
        if(doc != null && doc.getFirstFieldValue("v_fileSize") !== null){
            size = doc.getFirstFieldValue("v_fileSize");
        }
    }catch(e){
        logger.error(e);
    }
